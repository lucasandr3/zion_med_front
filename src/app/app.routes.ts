...
export const routes: Routes = [
  ...
  { path: 'l/:slug', loadComponent: () => import('./paginas/link-bio-public/link-bio-public.component').then(m => m.LinkBioPublicComponent) },
  {
    ...
    children: [
      ...
      { path: 'billing', canActivate: [permissionGuard], loadComponent: () => import('./paginas/billing/billing.component').then(m => m.BillingComponent), data: { titulo: 'Assinatura', permission: 'billing.manage' } },
      ...
      { path: 'templates', canActivate: [permissionGuard], loadComponent: () => import('./paginas/templates/templates-listagem.component').then(m => m.TemplatesListagemComponent), data: { titulo: 'Templates', permission: 'templates.manage' } },
      { path: 'templates/criar', canActivate: [permissionGuard], loadComponent: () => import('./paginas/templates/templates-criar.component').then(m => m.TemplatesCriarComponent), data: { titulo: 'Novo template', permission: 'templates.manage', urlVoltar: '/templates', labelVoltar: 'Voltar para Templates' } },
      { path: 'templates/criar-em-branco', canActivate: [permissionGuard], loadComponent: () => import('./paginas/templates/templates-criar-em-branco.component').then(m => m.TemplatesCriarEmBrancoComponent), data: { titulo: 'Novo template (em branco)', permission: 'templates.manage', urlVoltar: '/templates/criar', labelVoltar: 'Voltar à escolha de modelo' } },
      { path: 'templates/:id/editar', canActivate: [permissionGuard], loadComponent: () => import('./paginas/templates/templates-editar.component').then(m => m.TemplatesEditarComponent), data: { titulo: 'Editar template', permission: 'templates.manage', urlVoltar: '/templates', labelVoltar: 'Voltar para Templates' } },
      { path: 'templates/:id/campos', canActivate: [permissionGuard], loadComponent: () => import('./paginas/templates/templates-campos.component').then(m => m.TemplatesCamposComponent), data: { titulo: 'Campos', permission: 'templates.manage', urlVoltar: '/templates', labelVoltar: 'Voltar para Templates' } },
      ...
      { path: 'clinica/escolher', canActivate: [canSwitchOrganizationGuard], loadComponent: () => import('./paginas/clinica/clinica-escolher.component').then(m => m.ClinicaEscolherComponent), data: { titulo: 'Escolher empresa', urlVoltar: '/dashboard', labelVoltar: 'Dashboard' } },
      ...
      { path: 'link-bio', canActivate: [permissionGuard], loadComponent: () => import('./paginas/link-bio/link-bio.component').then(m => m.LinkBioComponent), data: { titulo: 'Link Bio', permission: 'organization.manage', urlVoltar: '/clinica/configuracoes', labelVoltar: 'Empresa' } },
