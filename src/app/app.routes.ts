...
export const routes: Routes = [
  ...
  { path: 'l/:slug', loadComponent: () => import('./paginas/link-bio-public/link-bio-public.component').then(m => m.LinkBioPublicComponent) },
  {
    ...
    children: [
      ...
      { path: 'pessoas', loadComponent: () => import('./paginas/pessoas/pessoas-listagem.component').then(m => m.PessoasListagemComponent), data: { titulo: 'Pessoas' } },
      { path: 'pessoas/criar', loadComponent: () => import('./paginas/pessoas/pessoas-formulario.component').then(m => m.PessoasFormularioComponent), data: { titulo: 'Nova pessoa', urlVoltar: '/pessoas', labelVoltar: 'Voltar para Pessoas' } },
      { path: 'pessoas/:id/editar', loadComponent: () => import('./paginas/pessoas/pessoas-formulario.component').then(m => m.PessoasFormularioComponent), data: { titulo: 'Editar pessoa' } },
      { path: 'pessoas/:id', loadComponent: () => import('./paginas/pessoas/pessoas-detalhe.component').then(m => m.PessoasDetalheComponent), data: { titulo: 'Ficha da pessoa' } },
