...
export const routes: Routes = [
  ...
  { path: 'l/:slug', loadComponent: () => import('./paginas/link-bio-public/link-bio-public.component').then(m => m.LinkBioPublicComponent) },
  {
    ...
    children: [
      ...
      { path: 'link-bio', canActivate: [permissionGuard], loadComponent: () => import('./paginas/link-bio/link-bio.component').then(m => m.LinkBioComponent), data: { titulo: 'Link na bio', permission: 'organization.manage', urlVoltar: '/clinica/configuracoes', labelVoltar: 'Empresa' } },
